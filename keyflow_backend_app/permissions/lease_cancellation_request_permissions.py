...
class IsOwnerOrReadOnly(BasePermission):
    """
    Custom permission to allow owners to modify or delete lease cancellation requests,
    and to allow tenants to create, view, and delete their own lease cancellation requests.
    """
    ...
    def has_object_permission(self, request, view, obj):
        user = request.user
        # Owners can modify or delete their own lease cancellation requests
        if user.account_type == 'owner':
            return obj.owner.user == user
        # Tenants can create, view, and delete their own lease cancellation requests
